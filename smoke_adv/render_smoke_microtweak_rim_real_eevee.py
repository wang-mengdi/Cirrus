...
# --- Realistic rim light + absorption tweaks (micro changes) ---
ABSORPTION_MULT = 1.2   # 1.0~2.0; higher = darker core + clearer rim
USE_EEVEE = True        # True: GPU realtime Eevee Next; False: Cycles (can still use GPU)
EEVEE_SAMPLES = 128     # Eevee volumetric samples (if available)
EEVEE_TILE_SIZE = '2'   # '2' or '4' in Eevee Next; smaller = better quality
...
if USE_EEVEE:
    # Eevee Next is GPU realtime by design
    scene.render.engine = 'BLENDER_EEVEE_NEXT'
    ee = scene.eevee
    for (k, v) in [
        ('taa_render_samples', EEVEE_SAMPLES),
        ('taa_samples', EEVEE_SAMPLES),
        ('use_volumetric_lights', True),
        ('use_volumetric_shadows', True),
        ('volumetric_samples', EEVEE_SAMPLES),
        ('volumetric_tile_size', EEVEE_TILE_SIZE),
        ('volumetric_end', 50.0),
